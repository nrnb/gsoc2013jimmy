...
/**
 * <code> SelectAllVisibleEdgesTaskFactoryImpl </code> implements the factory for the task responsible to select 
 * visible edges.
 * 
...
public class SelectAllVisibleEdgesTaskFactoryImpl<T> extends AbstractNetworkTaskFactory implements SelectAllNodesTaskFactory
{
	...
	/**
	 * <code> SelectAllVisibleEdgesTaskFactoryImpl </code> constructor.
	 * @param undoSupport
	 ...
	 * @param end
	 */
	public SelectAllVisibleEdgesTaskFactoryImpl(
	...
	public TaskIterator createTaskIterator(CyNetwork network) 
	{
		return new TaskIterator(
				new SelectAllVisibleEdgesTask<T>(undoSupport, network,dynNetworkManager.getDynNetwork(network),networkViewManager, eventHelper, start, end));
	}
